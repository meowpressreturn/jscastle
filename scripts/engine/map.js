...
Map.cellTypes[34] = 'images/woodRail1.png';
Map.cellTypes[35] = 'images/woodRail2.png';
Map.cellTypes[36] = 'images/woodBridge1.png';
Map.cellTypes[37] = 'images/woodBridge2.png';
Map.cellTypes[38] = 'images/dangerSign.png';
Map.cellTypes[39] = 'images/woodLadder.png';
Map.cellTypes[40] = 'images/ropeLadder.png';

Map.cellTypes[41] = 'images/spikes.png';
Map.cellTypes[42] = 'images/cactus.png';
Map.cellTypes[43] = 'images/shade.png';

Map.cellTypes[44] = 'images/blank.png';
Map.cellTypes[45] = 'images/cyanClouds.png';

Map.cellTypes[46] = 'images/metalLadder.png';
Map.cellTypes[47] = 'images/wall3Window.png';
Map.cellTypes[48] = 'images/roofSharp.png';
Map.cellTypes[49] = 'images/rock.png';
Map.cellTypes[50] = 'images/wall2VBladeTrack.png';

Map.cellTypes[51] = 'images/vase.png';
Map.cellTypes[52] = 'images/flowerPot.png';
Map.cellTypes[53] = 'images/sword.png';
Map.cellTypes[54] = 'images/bars.png';

Map.cellTypes[55] = 'images/flameAni.gif';

Map.cellTypes[56] = 'images/chairLeft.png';
Map.cellTypes[57] = 'images/chairRight.png';
Map.cellTypes[58] = 'images/table.png';



//Certain cell types in the foreground and background are used as ladders. This function returns true if the
//map cell provided has such a type in the foreground or background
Map.isCellClimbable = function(cell)
{
	var climbable =	   (cell.foreground == 23 || cell.background == 23)
					|| (cell.foreground == 39 || cell.background == 39)
					|| (cell.foreground == 40 || cell.background == 40);
	return climbable;
}
...
//Creates and shows sprite objects for each cell in the map. These are not added to the global
	...
	for(var x=0; x < this.width; x++)
	{
		for(var y=0; y < this.height; y++)
		{
			...
			if(cell.foreground)
			{
				...
				cell.foreSprite.node.style.zIndex = 10;
			}
			if(cell.midground)
			{
				cell.midSprite = new Sprite(worldX,worldY, Map.cellTypes[cell.midground] );
				cell.midSprite.show();
				cell.midSprite.node.style.zIndex = 5;
			}
			if(cell.background)
			{
...
//TODO - given that cell size is now constant these methods belong in Map and not map
Map.worldToMapY = function(worldY)
{
	return Math.floor( worldY / Map.cellHeight );
}

//Converts a horizontal X coordinate in world units to a map column index
Map.worldToMapX = function(worldX)
{
	return Math.floor( worldX / Map.cellWidth ); // More a case of Math.wall() ... ;-)
}

//Converts a vertical row index in map coordinates to world coordinate units
Map.mapToWorldY = function(mapY)
{
	return mapY * Map.cellHeight;
}

//Converts a horizontal column index in map coordinates to a coordinate in world coordinate units
Map.mapToWorldX = function(mapX)
{
	return mapX * Map.cellWidth;
}

//Obsolete instance versions now refer to the static version
Map.prototype.worldToMapY = Map.worldToMapY;
Map.prototype.worldToMapX = Map.worldToMapX;
Map.prototype.mapToWorldY = Map.mapToWorldX;
Map.prototype.mapToWorldX = Map.mapToWorldY;
